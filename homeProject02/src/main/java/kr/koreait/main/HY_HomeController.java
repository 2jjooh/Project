...
public class HY_HomeController {
	...
	public String dressList(HttpServletRequest request, Model model) {
		MybatisDAO mapper = sqlSession1.getMapper(MybatisDAO.class);
		...
		int totalCount = mapper.dressCount();
		logger.info("dressCount is = " + totalCount);
//		System.out.println(totalCount);
		...
		hmap.put("startNo", goodsList.getStartNo());
		hmap.put("endNo", goodsList.getEndNo());
		goodsList.setGoodList(mapper.dressList(hmap));
