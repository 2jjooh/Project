...
public class UB_HomeController {
	...
	@Resource(name= "uploadPath_dress")
	private String uploadPath_dress;
...
//		컬러, 색상, 사이즈 분류 알고리즘
		...
		if(category.equals("top")) {
			...
			savedFileName = FileUtills.uploadFile(file,uploadPath_dress,goodsVO);
			savedFileName_sub = FileUtills.uploadFile_sub(goodsVO.getSub_file(), uploadPath_dress, goodsVO);
			setIdPhotoNum(goodsVO, savedFileName, savedFileName_sub, photoNum);
			mapper.insertGoods_dress(goodsVO);
		}
